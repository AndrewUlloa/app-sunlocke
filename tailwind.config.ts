...
const config: Config = {
  ...
  theme: {
  	extend: {
  		...
  		fontFamily: {
  			tobiasLight: [
  				'var(--font-tobias-light)'
  			],
  			tobiasRegular: [
  				'var(--font-tobias-regular)'
  			],
  			tobiasMedium: [
  				'var(--font-tobias-medium)'
  			],
  			tobiasSemiBold: [
  				'var(--font-tobias-semibold)'
  			],
  			eudoxusSansRegular: [
  				'var(--font-eudoxus-sans-regular)'
  			],
  			eudoxusSansMedium: [
  				'var(--font-eudoxus-sans-medium)'
  			],
  			eudoxusSansBold: [
  				'var(--font-eudoxus-sans-bold)'
  			],
  			geistSans: [
  				'var(--font-geist-sans)'
  			],
  		...
  		keyframes: {
  			...
  			backgroundFade: {
  				'0%': {
  					backgroundColor: '#ce9cf4'
  				},
  				'20%': {
  					backgroundColor: '#efc9e9'
  				},
  				'40%': {
  					backgroundColor: '#faca97'
  				},
  				'60%': {
  					backgroundColor: '#fae59f'
  				},
  				'80%': {
  		...
  		boxShadow: {
  			'text-shadow': [
  				'2px 1px 3px rgba(255, 255, 255, 0.7)'
  			],
  			'red-card-default': [
  				'0 4px 16px rgba(220, 68, 53, 0.5)'
  			],
  			'red-card-hover': [
  				'0 4px 16px rgba(220, 68, 53, 0.75)'
  			],
